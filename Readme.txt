Device utilizado no Android Studio: 
...
------------------------------------------------------------------------------------------------------------------------------
A Página de detalhes apenas possui o nome/id e imagem, pois são os únicos dados que a API retorna, a Descrição é fixa apenas para preencher.
